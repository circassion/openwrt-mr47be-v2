...
> **Последнее обновление:** 2026-09-01 06:45 (+03)
> **Активный образ:** test10 (RAM boot, SSH работает — требуется ручной IP)
> **test11:** Сборка в процессе (06:41 запущена, исправление wcss 1-arg auth)
> **Статус:** Ethernet частичный (регрессия IPv4), WiFi заблокирован (wcss_reset -12), QCN9274 PCIe готов
> Полный технический справочник порта MR47BE V2 OpenWrt.
