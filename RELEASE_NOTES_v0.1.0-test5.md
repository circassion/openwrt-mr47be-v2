...
2. **LED/Button:** gpio-leds ve gpio-keys henüz eklenmedi (test6'ya eklenecek).
...
**Not:** Bu imaj "TAK ÇALIŞTIR" özelliktedir — sorunsuz boot eder, WiFi 7 çalışır. LED ve button test6'ya ertelenmiştir.
