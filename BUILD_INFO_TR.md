# BUILD_INFO — Mercusys MR47BE V2 OpenWrt (test10 → test11)

> **Son güncelleme:** 2026-09-01 06:45 (+03)
> **Aktif imaj:** test10 (RAM boot, SSH/WinSCP calisiyor — manual IP gerek)
> **test11:** Build devam ediyor (06:41 basladi, wcss 1-arg auth denemesi)
> **Durum:** Ethernet kismi (IPv4 regression), WiFi bloke (wcss_reset -12), QCN9274 PCIe hazir bekliyor
> Bu dosya MR47BE V2 OpenWrt port'unun eksiksiz teknik referansidir.

---

## HIZLI OZET (test1 → test11)

| Test | Tarih | Sonuc | Kritik Bulgu |
|------|-------|-------|-------------|
| test1-3 | 28.08 | | QCA8386 varsayimi YANLIS |
| test4 | 28.08 | Ilk build OK | SoC=IPQ5322, Eth=QCA8084, 6G=QCN6274 |
| test5-6 | 29.08 | RAM boot OK | Q6 -22 -> -12 analizi |
| test7 | 30.08 | 2010b patch | 3-arg MPD auth: -EINVAL -> -ENOMEM |
| test8 | 31.08 | QCA8084 DTS fix | C45/@7/@29 DENEMESI YANLIS |
| test9 | 31.08 | 0313 patch | ETHERNET COZULDU (LAN 2.5Gbps) |
| test10 | 31.08 | 2010c patch | wcss_reset -12 devam, secure-binary blob bulundu |
| test11 | 01.09 | BUILD DEVAM | 1-arg auth + metadata |

---

## DONANIM (KESIN, FOTO KANITLI)

| Bilesen | Marking | Detay |
|---------|---------|-------|
| SoC | IPQ5322 003 FK5134HJ | 4x Cortex-A53, 1 GiB DDR4 |
| 6 GHz Radio | QCN6274 001 JE510CV2 | PCIe [17cb:1109] hw2.0 |
| NAND | Winbond W25N01GWZEIG | 128 MiB, 2048B page |
| Ethernet | QCA8084 (SoC ici) | 4x 2.5G switch-PHY, ayri cip YOK |
| UART | 4-pin J1 | GPIO18/19 @ 115200 8N1 |
| Secure Boot | KAPALI | Imzasiz OpenWrt RAM boot MUMKUN |
