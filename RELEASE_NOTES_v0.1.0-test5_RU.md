...
2. **LED/Button:** gpio-leds и gpio-keys присутствуют в образе (были и в test4).
...
**Примечание:** Этот образ "TAK ÇALIŞTIR" — загружается бесшовно, WiFi 7 работает (QCN6274), ядро 6.18.39, поддержка USB отключена, LED (gpio-leds) и кнопка сброса (gpio-keys) присутствуют.
