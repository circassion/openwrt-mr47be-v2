...
> **Last updated:** 2026-09-01 06:45 (+03)
> **Live image:** test10 (RAM boot, SSH works — manual IP required)
> **test11:** Build in progress (06:41 started, wcss 1-arg auth fix)
> **Status:** Ethernet partial (IPv4 regression), WiFi blocked (wcss_reset -12), QCN9274 PCIe ready
> This file is the complete technical reference for the MR47BE V2 OpenWrt port.
