...
2. **LED/Button:** gpio-leds and gpio-keys not yet added (to be added in test6).
...
**Note:** This image is "TAK ÇALIŞTIR" — boots seamlessly, WiFi 7 works. LED and button deferred to test6.
